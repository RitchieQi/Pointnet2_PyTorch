...
from pointnet2_ops import pointnet2_utils
from handpointnet2 import getPretrainedHandglobal
from handpointnet2_vote_refine_msg import get_model as refine_model
...
class PointNet2_refine(nn.Module):
    ...
    def _build_model(self):
        ...
        self.refine1 = refine_model()
        self.refine1 = self.refine1.cuda()
        checkpoint = torch.load('checkpt/jointSAMSG.pth')
        self.refine1.load_state_dict(checkpoint['model_state_dict'])
    ...
    def forward(self, pointcloud):
        ...
        with torch.no_grad():
            ...
            est_centroids = estimate.unsqueeze(-1).view(-1,21,3).contiguous()
        ''' refine part '''
