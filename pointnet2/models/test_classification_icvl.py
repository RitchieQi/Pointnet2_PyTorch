...
from ICVL_dataset import ICVLHand, ICVLHand_16Ver
...
def test(model, loader):
    ...
    for j, (points, target) in tqdm(enumerate(loader), total=len(loader)):
        ...
        pred = pred.unsqueeze(-1).view(32,16,3)
...
def main(args):
    ...
    checkpoint = torch.load(str(experiment_dir) + '/checkpoints/ICVL16handGlobal.pth')
